...
{
    public partial class frmItemwisePurchaseReport : CustomForm
    {
        public frmItemwisePurchaseReport()
        {
            InitializeComponent();
        }

        private void frmItemwisePurchaseReport_Load(object sender, EventArgs e)
        {
        ...
        private void udfGenerateReport()
        {
            try
            {
                CrItemwisePurchase    CRItemwise = new CrItemwisePurchase ();
        ...
        private void frmItemwisePurchaseReport_Shown(object sender, EventArgs e)
        {
           // udfGenerateReport();
        }
    }
