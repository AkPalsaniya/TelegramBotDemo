...
{
    public partial class frmMonthlyPurchase : CustomForm
    {
        public frmMonthlyPurchase()
        {
            InitializeComponent();
        }

        private void frmMonthlyPurchase_Load(object sender, EventArgs e)
        {
        ...
        {
            CRMonthlyPurcahse monthlypurchase = new CRMonthlyPurcahse();
            ConnectionInfo connectionInfo = new ConnectionInfo();
            TableLogOnInfo logonInfo = new TableLogOnInfo();
            logonInfo = monthlypurchase.Database.Tables[0].LogOnInfo;
            ...
            monthlypurchase.Database.Tables[0].ApplyLogOnInfo(logonInfo);
            crystalReportViewer1.ReportSource = monthlypurchase;
